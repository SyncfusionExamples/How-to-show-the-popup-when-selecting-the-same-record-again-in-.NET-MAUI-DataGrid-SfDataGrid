...
namespace SfDataGridSample
{
    public class EmployeeViewModel : IDisposable, INotifyPropertyChanged
    {
        ...
        public bool IsPopupOpen
        {
            ...
            {
                _isPopupOpen = value;
                NotifyPropertyChanged(nameof(IsPopupOpen));
            }
        }
        public ObservableCollection<string> CustomerNames { get; set; }
        private string _selectedEmployeeDetails;
        public string SelectedEmployeeDetails
        {
            get { return _selectedEmployeeDetails; }
            set
            {
                _selectedEmployeeDetails = value;
                NotifyPropertyChanged(nameof(SelectedEmployeeDetails));
            }
        }
